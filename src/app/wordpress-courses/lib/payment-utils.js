...
import { FaCheck, FaPlay, FaArrowLeft, FaDownload } from "react-icons/fa"
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                onClick={() => router.push("/wordpress-courses")}
                className="flex items-center justify-center px-4 py-3 border border-[#21759b] rounded-lg text-[#21759b] hover:bg-[#21759b]/5 transition-colors duration-200"
              >
              ...
              <button
                ...
                className="flex items-center justify-center px-4 py-3 bg-[#21759b] text-white rounded-lg hover:bg-[#1d6586] transition-colors duration-200"
              >
            ...
            <div className="mt-4">
              <button
                onClick={() => window.open("/wordpress-courses/invoice.pdf", "_blank")}
