...
export const metadata = {
  title: "Technology News | Webitya News",
  description: "Stay updated with the latest technology news, innovations, and digital trends from Webitya News.",
  keywords: "technology news, tech updates, digital trends, innovations, Webitya news",
}

export default function Page() {
  return (
    <Suspense fallback={<TechnologyNewsLoading />}>
      <CategoryNewsPage params={{ category: "technology" }} />
    </Suspense>
  )
}

function TechnologyNewsLoading() {
  return (
