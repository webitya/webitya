...
export const metadata = {
  title: "Sports News | Webitya News",
  description: "Stay updated with the latest sports news, events, and analysis from Webitya News.",
  keywords: "sports news, sports updates, sports events, sports analysis, Webitya news",
}

export default function Page() {
  return (
    <Suspense fallback={<SportsNewsLoading />}>
      <CategoryNewsPage params={{ category: "sports" }} />
    </Suspense>
  )
}

function SportsNewsLoading() {
  return (
