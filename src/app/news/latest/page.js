...
export const metadata = {
  title: "Latest News | Webitya News",
  description: "Stay updated with the most recent news and developments from around the world.",
  keywords: "latest news, recent updates, breaking news, Webitya news",
}
