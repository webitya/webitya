const influencers = [
    {
      ...
      description:
        "Pravin is a talented actor and content creator known for his unique storytelling and charm.",
      age: 25,
      height: "5'8\"",
      demoVideos: [
        "/demos/pravin1.mp4",
    ...
    },
    {
      ...
      name: "Anjali Mahto",
      category: "Fashion",
      image: "/influencers/anjali-mahto.jpg",
      followers: "85K+",
      link: "https://bookwith.me/anjali",
      description:
        "Anjali is a trending fashion influencer from Ranchi who collaborates with popular brands.",
      age: 22,
      height: "5'6\"",
      demoVideos: [
        "/demos/anjali1.mp4",
    ...
    },
    {
      ...
      description:
        "Preeti is a rising fashion model known for bold style and elegant shoots.",
      age: 24,
      height: "5'7\"",
      demoVideos: [
        "/demos/preeti1.mp4",
    ...
    },
    {
      ...
      description:
        "Rahul shares powerful lifestyle content and is open for brand collaborations.",
      age: 27,
      height: "5'9\"",
      demoVideos: [
        "/demos/rahul1.mp4",
    ...
    },
    {
      ...
      description:
        "Nisha shares beauty tips and skincare routines with a growing audience.",
      age: 23,
      height: "5'5\"",
      demoVideos: [
        "/demos/nisha1.mp4",
    ...
    },
    {
      ...
      description:
        "Akjali creates fun, trendy content that resonates with young audiences.",
      age: 21,
      height: "5'4\"",
      demoVideos: [
        "/demos/akjali1.mp4",
