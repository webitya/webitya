      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            <TopStatCard label="Main Pages" value={mainNavLinks.length} color="from-blue-500 to-blue-700" />
            <TopStatCard label="Blog Categories" value={categories.length} color="from-green-500 to-green-700" />
            <TopStatCard label="Blog Articles" value={allArticles.length} color="from-purple-500 to-purple-700" />
            <TopStatCard
              label="Service Pages (incl. locations)"
              value={allDynamicKeywords.length}
